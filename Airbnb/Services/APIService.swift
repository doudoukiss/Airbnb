...
final class APIService {
    ...
    struct Constants {
        static let apiUrl = URL(string:
                                    "https://public.opendatasoft.com/api/explore/v2.1/catalog/datasets/airbnb-listings/records?limit=10&lang=en&refine=city%3A%22New%20York%22&refine=room_type%3A%22Entire%20home%2Fapt%22")
    }
